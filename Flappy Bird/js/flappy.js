...
function FlappyBird(){
    ...
    let pontos = 0
    const music = new Audio('imgs/musica.wav')
    music.play()
    ...
    const barreiras = new Barreiras(altura,largura, 400, 400, () => progresso.atualizarPontos(++pontos) )
...
// const barreiras = new Barreiras(700, 1000, 200, 500)
